...
@section('content')
    ...
    <div class="card mb-3">
        <div class="card-body d-flex gap-4">
            <img src="https://awsimages.detik.net.id/community/media/visual/2022/05/08/jamur-tiram-untuk-bakwan_169.jpeg?w=1200"
                width="300" alt="">
            <form action="" method="">
                ...
                <div class="desc w-100">
                    ...
                    <input type="number" class="form-control border-0 fs-1" name="harga" id="harga" value="20000">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-5 d-flex">
                            ...
                            <input type="number" name="qty" class="form-control w-25 text-center qty" id="qty"
                                min="1" max="99" name="qty" value="1">
